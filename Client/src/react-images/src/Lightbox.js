...
class Lightbox extends Component {
		...
		return (
			...
			>
				<div className={css(classes.content)} style={{ marginBottom: offsetThumbnails, maxWidth: width }}>
					<Header
						suggestExit={this.props.votedPhotosIds.length === 12}
	...
	renderImages () {
		...
		const isVoted = this.props.votedPhotosIds.indexOf(image.id) > -1;
		...
		return (
			<figure className={css(classes.figure)}>
				...
				*/}
				<div onClick={!!onClickImage && onClickImage} title='Kliknij aby zagłosować na to zdjęcie'>
					<img
